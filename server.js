// ─── PesaFlow — Tanzania Mobile Money Gateway ──────────────────────────────
...
async function getToken() {
  ...
  console.log('[PesaFlow] Generating new auth token...');
  ...
  if (res.data.success && res.data.token) {
    ...
    console.log('[PesaFlow] Token generated OK');
    return authToken;
  }
...
app.listen(PORT, () => {
  console.log(`\n  ╔══════════════════════════════════════╗`);
  console.log(`  ║   🚀 PesaFlow is running             ║`);
